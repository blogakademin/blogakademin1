...
- The medicine itself: 
- APOE genotyping: 
- MRI scans to assess ARIA:
- PET scans to assess amyloid clearance<br>
<br>
...
- Caregiver burden
- QALYs
- Incremental cost-effectiveness ratios (ICER): difference in cost between two possible interventions, divided by the difference in their effect
- Value-based prices: maximum price at which a treatment would be cost-effective given a cost-effectiveness threshold??
- Likelihood of being cost-effective<br>
<br>

### **Potential data sources for cost-effectiveness analyses**
- Published data from clinical trials
- Published data on AD natural history, its associated costs<br>
<br>
...
- Outpatient care, inpatient care, home care, medications, and long-term care, and societal costs
- Adverse event and associated cost and utility decrement
- Costs of drugs, infusion supplies, services, monitoring, screening workup
- Cycle length and transition probability
- Transition probability of adverse event<br>
<br>

### **Parameter specification**
- Transition probabilities
- Hazard ratios for transition probabilities
- Effect-specific QALYs: e.g., 0.8 gains in QALYs per 20% treatment effects??<br>
<br>
...
- Methodological challenges
  ...
  * Assumptions of off-label usage?? and treatment adherence
- Other considerations
  * Currency value fluctuations<br>
<br>
